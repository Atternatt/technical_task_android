...
class DefaultGetAuthTokenInteractor constructor(private val getRepository: GetRepository<AuthToken>) : GetAuthTokenInteractor {

    companion object {
        const val EMPTY_TOKEN = ""
    }

    override fun invoke(): Single<AuthToken> = getRepository.get(AuthTokenQuery, CacheOperation).single(AuthToken(EMPTY_TOKEN))
}